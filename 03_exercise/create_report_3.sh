#!/usr/bin/env bash
set -x
# -x option for bash will print commands and their arguments when they are executed. 
# Another way of setting the bash in debug mode with set -x option instead of passing options as in create_report_2.sh.
